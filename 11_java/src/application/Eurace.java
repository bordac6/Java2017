...
public class Eurace extends Application {
	...
	class Playground extends Canvas {
		public void paint() {
			...
			images[0] = new Image("1.gif", (double) offset / 2, (double) offset / 2, false, false);
			images[1] = new Image("2.gif", (double) offset / 2, (double) offset / 2, false, false);
			images[2] = new Image("5.gif", (double) offset / 2, (double) offset / 2, false, false);
			images[3] = new Image("10.gif", (double) offset / 2, (double) offset / 2, false, false);
			images[4] = new Image("20.gif", (double) offset / 2, (double) offset / 2, false, false);
			images[5] = new Image("50.gif", (double) offset / 2, (double) offset / 2, false, false);
